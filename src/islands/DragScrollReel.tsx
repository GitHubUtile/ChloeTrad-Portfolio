          ...
          return (
            ...
            >
              ...
              <div
                ...
                style={{ background: `linear-gradient(180deg, rgba(0,0,0,0) 40%, ${card.accent}AA 100%)` }}
              ></div>
              <div className="absolute inset-0 p-6 lg:p-10 flex flex-col justify-between text-white">
                <div className="flex items-start justify-between font-mono text-xs uppercase tracking-[0.15em]">
                  <span>{card.discipline}</span>
                  <span>{card.year}</span>
                </div>
                <div>
                  <h3 className="font-display font-semibold text-[clamp(1.75rem,3vw,2.75rem)] leading-[1.05] text-balance max-w-[18ch]">
                    {card.title}
                  </h3>
                </div>
              </div>
